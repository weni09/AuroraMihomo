...
- a structured UI/UX reference and review playbook, and
- a searchable local design knowledge base via the bundled scripts in `skills/ui-ux-pro-max/scripts/`.

In this workspace, the supporting datasets and search scripts are present locally, so the command examples below can be used as executable workflows.
