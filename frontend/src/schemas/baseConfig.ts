...
export const baseConfigSchema: FormSection[] = [
  {
    ...
    fields: [
      ...
      { key: 'global-client-fingerprint', title: '全局客户端指纹 (Global Client Fingerprint)', type: 'text', placeholder: 'chrome', help: '可选 chrome / firefox / safari / ios / random 等，为所有出站统一设置 TLS 指纹。留空表示不设置。' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'redir-port', title: '透明代理端口 (Redir，仅 Linux/macOS)', type: 'number', placeholder: '7892', help: '透明代理端口（redir），仅支持 TCP，一般配合 iptables 使用。' },
      { key: 'tproxy-port', title: 'TProxy 端口 (仅 Linux)', type: 'number', placeholder: '7893', help: '透明代理端口（TProxy），支持 TCP/UDP，仅 Linux。' },
    ],
  },
  {
    id: 'controller',
